<?php
session_start();
require 'C:/xampp/htdocs/decofruta/modelo/conexion_bd.php';
    ...
    <div class="all-content">
        ...
        <header class="header">
            <nav class="navbar navbar-expand-md" id="navbar">
                <a class="navbar-brand" href="./vista/clienteInicio.php" id="logo"><img src="./image/logoNav.png" alt="" width="100">Decofruta Piura</a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="./vista/clienteProductos.php" class="nav-link dropdown-toggle" id="navbardrop" data-toggle="dropdown">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./vista/clienteGaleria.php">Galeria</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./vista/clienteNosotros.php">Nosotros</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./vista/clienteReservarMesa.php">Reservar Mesa</a>
                        </li>
                ...
                <div class="container-icon">
                    <div class="container-cart-icon">
                        <div class="icons">
                            <a href="./vista/acceso.php"><i class='bx bxs-user-plus'></i></a>
                            <a href="./vista/logout.php"><i class='bx bx-log-out-circle'></i></a>
